...
$('.waifu-tool .fui-home').click(function (){
    window.location = 'https://qiuliqi.top/2233/dtbz.html?bottom=40&right=20';
...
(function (){
    ...
    if (window.location.href == SiteIndexUrl) {      // 如果是主页
        ...
        if(document.referrer !== ''){
            ...
            text = '欢迎使用<span style="color:#0099cc;">『' + document.title.split(' - ')[0] + '』</span> 刚开机背景空白请点击看板娘右边第一个按钮，谢谢！';
        }
    }
...
function loadModel(modelId, modelTexturesId){
   ...
   // localStorage.setItem('modelTexturesId', modelTexturesId);
    loadlive2d('live2d','https://cdn.jsdelivr.net/gh/qiuliqi/live2d@1.0/model.json'/*'https://qiuliqi.top/xxb2/model/xxb/model.json'*//*'https://api.fghrsh.net/live2d/get/?id='+modelId+'-'+modelTexturesId*/, console.log('live2d','模型 '+modelId+'-'+modelTexturesId+' 加载完成'));
}
...
/*function loadRandModel(){
    ...
    $.ajax({
        cache: false,
        url: 'https://qiuliqi.top/2233/live2d_api/'+modelTexturesRandMode+'_textures/?id='+modelId+'-'+modelTexturesId,
        dataType: "json",
        success: function (result){
